...
/* Define to 1 if you have the `libtiff-4' library (-llibtiff-4). */
/* #undef HAVE_LIBLIBTIFF_4 */
...
/* Support flexible OpenSSL methods */
/* #undef SPANDSP_SUPPORT_FLEXSSL */

/* Support SSL Fax */
/* #undef SPANDSP_SUPPORT_SSLFAX */
